...
// The service layer consumes Neon query results as row arrays. Keep this boundary
// dynamic because Neon exposes several result shapes depending on its options.
