          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-2xl font-black text-amber-400 font-mono mt-2">
                  {formatCurrency(product.priceFCFA, currency === "EUR" ? "EUR" : "FCFA")}
                </p>
            ...
            <div className="space-y-2 pt-4 border-t border-slate-800">
              ...
              >
                ...
                <span>Ajouter au Panier ({formatCurrency(product.priceFCFA, currency === "EUR" ? "EUR" : "FCFA")})</span>
              </button>

              <a
                href={`https://wa.me/221705334611?text=${encodeURIComponent(`Bonjour SEN AURA TECH, je souhaite commander l'article "${product.name}" au prix de ${product.priceFCFA} FCFA.`)}`}
                target="_blank"
                rel="noreferrer"
